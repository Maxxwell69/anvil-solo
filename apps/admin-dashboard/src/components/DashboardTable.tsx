...
const DashboardTable: React.FC = () => {
    const tokens: TokenTradesInterface[] = [
        // { from: '7h 38m ago', token: 'Eth', amount: 201.38, usd: 201.38, fee: 215.0, type: 1 },
        // { from: '4h 12m ago', token: 'USDT', amount: 15.25, usd: 15.25, fee: 120.0, type: 2 },
        // { from: '3h 2m ago', token: 'Add', amount: 5863.5, usd: 5863.5, fee: 20.51, type: 3 },
        // { from: '5h 2m ago', token: 'Sell', amount: 563.5, usd: 563.5, fee: 520.51, type: 1 },
        // { from: '4h 38m ago', token: 'Remove', amount: 201.38, usd: 201.38, fee: 215.0, type: 4 },
        // { from: '5h 12m ago', token: 'Buy', amount: 15.25, usd: 15.25, fee: 120.0, type: 1 },
        // { from: '1h 2m ago', token: 'Sell', amount: 5863.5, usd: 5863.5, fee: 20.51, type: 1 },
        // { from: '2m ago', token: 'Buy', amount: 563.5, usd: 563.5, fee: 520.51, type: 1 },
        // { from: '7h 38m ago', token: 'Sell', amount: 201.38, usd: 201.38, fee: 215.0, type: 2 },
        // { from: '4h 12m ago', token: 'Buy', amount: 15.25, usd: 15.25, fee: 120.0, type: 1 },
        // { from: '3h 2m ago', token: 'Add', amount: 5863.5, usd: 5863.5, fee: 20.51, type: 3 },
        // { from: '5h 2m ago', token: 'Sell', amount: 563.5, usd: 563.5, fee: 520.51, type: 1 },
        // { from: '4h 38m ago', token: 'Remove', amount: 201.38, usd: 201.38, fee: 215.0, type: 4 },
        // { from: '5h 12m ago', token: 'Buy', amount: 15.25, usd: 15.25, fee: 120.0, type: 1 },
        // { from: '1h 2m ago', token: 'Sell', amount: 5863.5, usd: 5863.5, fee: 20.51, type: 2 },
        // { from: '2m ago', token: 'Buy', amount: 563.5, usd: 563.5, fee: 520.51, type: 1 },
    ];

    const [sortConfig, setSortConfig] = useState<{ key: keyof TokenTradesInterface; direction: 'ascending' | 'descending' | null }>({
        key: 'created',
        direction: 'ascending',
    });
    ...
    const onSort = (key: keyof TokenTradesInterface) => {
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>
                                <header>
                                    <span>from</span>
                                    {/* <svg className='sort' width={32} height={32} xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" onClick={() => onSort('from')}>
                    ...
                    <tbody>
                        {/* {
                            sortedTokens.map((token, i) => (
                                <tr key={i} className={`${token.type === 1 ? 'text-red' : token.type === 2 ? 'text-green' : token.type === 3 ? 'text-blue' : 'text-gray'}  `}>
                                    <td className={`${token.type === 1 ? 'text-red' : token.type === 2 ? 'text-green' : token.type === 3 ? 'text-blue' : 'text-gray'}`} >
                                        {
                                            token.type === 1 ?
                                                (
                                    ...
                                    <td>{token.from.toLocaleString()}</td>
                                    <td>{token.token}</td>
                                    <td>{token.amount.toFixed(2)}</td>
                                    <td>{token.usd.toFixed(2)}</td>
                                    <td>{token.fee.toFixed(2)}</td>
                                </tr>
                            ))
                        } */}
                    </tbody>
